...
def makePlots(orientation, orientationIndex, res, obs, model, catalogSpectrum):
    ...
    truths[7] = stellarMass[nameMask][orientationIndex]
    #truths = None
    # corner plot
...
plotPath = '/scratch/ntf229/catalogFitTest/ProspectorAlphaPlots/'
...
if args.sampling == 'mcmc':
    ...
    plotPath += 'mcmc/'+args.fitType+'/numWalkers'+args.nwalkers+'/numIter'+args.niter+'/'+args.galaxy+'/'
    ...
    plotPath += 'dynesty/'+args.fitType+'/'+args.galaxy+'/'
    faceSpectrum = spectrum[nameMask][faceIndex]
    edgeSpectrum = spectrum[nameMask][edgeIndex]
else:
