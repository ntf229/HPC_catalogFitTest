...
#SBATCH --time=10:00
#SBATCH --mem=5GB
#SBATCH --job-name=globalAnalysis
...
python /home/ntf229/catalogFitTest/bin/globalAnalysis.py \
--dust=True --sfh=prospector-alpha --dust_type=milky_way --fitType=DustPedia \
