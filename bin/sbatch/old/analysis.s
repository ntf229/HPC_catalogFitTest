...
python /home/ntf229/catalogFitTest/bin/analysis.py \
--dust=False --sfh=prospector-alpha --dust_type=milky_way --fitType=DustPedia \
--sampling=mcmc --nwalkers=64 --niter=5000 --galaxy=${galaxies[$SLURM_ARRAY_TASK_ID]}"
