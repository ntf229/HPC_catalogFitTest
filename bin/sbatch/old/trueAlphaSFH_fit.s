...
#SBATCH --time=5:00:00
#SBATCH --mem=5GB
#SBATCH --job-name=trueAlphaSFH_fit
...
python /home/ntf229/catalogFitTest/bin/trueAlphaSFH_fit.py \
--dust=False --dust_type=calzetti --fitType=DustPedia \
--sampling=mcmc --nwalkers=16 --niter=500 --galaxy=${galaxies[$SLURM_ARRAY_TASK_ID]}"
