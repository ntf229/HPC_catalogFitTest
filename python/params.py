...
def build_model(object_redshift=0.0, fixed_metallicity=None, add_duste=False,
    ...
    if args.sfh == 'delayed-tau':
        ...
        model_params["tage"] = {"N": 1, "isfree": True, "init": 10, 
                                "prior": priors.LogUniform(mini=0.001, maxi=13.8)} # in Gyrs
        model_params["mass"] = {"N": 1, "isfree": True, "init": 1e11, "init_disp": 1e10, 
                                "prior": priors.LogUniform(mini=1e7, maxi=1e12)}
        print('using delayed-tau sfh')
        ...
        model_params["total_mass"] = {"N": 1, "isfree": True, "init": 1e11, "init_disp": 1e10, 
                                      "prior": priors.LogUniform(mini=1e7, maxi=1e12)}
        print('using prospector-alpha sfh')
    else:
        print('invalid sfh')
        exit()
